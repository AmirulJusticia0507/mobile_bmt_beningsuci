...
$query = "SELECT id, no_rek, nama_nasabah, jenis_kelamin, alamat, tgl_mulai, saldo_akhir, kolektor FROM db_tabungan_bmt_beningsuci.tabungannasabah LIMIT 0, 1000";
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <main class="content">
                ...
                <!-- Tabel Data Nasabah -->
                <div class="container">
                    <table id="rekapDataTableNasabah" class="display table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>No Rekening</th>
                        ...
                        <tbody>
                            <?php foreach ($nasabah_data as $nasabah): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($nasabah['id']); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['no_rek']); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['nama_nasabah']); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['jenis_kelamin']); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['alamat']); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['tgl_mulai']); ?></td>
                                    <td><?php echo 'Rp ' . number_format($nasabah['saldo_akhir'], 2, ',', '.'); ?></td>
                                    <td><?php echo htmlspecialchars($nasabah['kolektor']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#rekapDataTableNasabah').DataTable({
                responsive: true,
                paging: true,
                searching: true,
                ordering: true,
