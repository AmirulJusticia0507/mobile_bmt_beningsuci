...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT userid, username, fullname FROM db_tabungan_bmt_beningsuci.users WHERE username = ? OR fullname = ?";
...
<head>
    ...
    <title>Forgot Password Sitabung BMT BENING SUCI</title>
...
<body>
    <div class="content">
        ...
        <div class="text">Forgot Password <span style="color:green">Sitabung Bening Suci</span></div>
